import {
  ...
  map,
  require_warning
} from "./chunk-IOERUFL7.js";
import {
  Col_default,
  useCol
} from "./chunk-CSHV2C5T.js";
import {
  Row_default
} from "./chunk-4BLBCIOW.js";
import {
...
function useForceUpdate() {
  const [, dispatch] = (0, import_react12.useReducer)((state) => !state, false);
  return dispatch;
}
...
function useSafeState(state) {
  const isMounted = useMounted();
  return [state[0], (0, import_react13.useCallback)((nextState) => {
    if (!isMounted())
      return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const prevModifiers = (0, import_react14.useRef)(modifiers);
  const popperInstanceRef = (0, import_react14.useRef)();
  const update = (0, import_react14.useCallback)(() => {
    var _popperInstanceRef$cu;
    (_popperInstanceRef$cu = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu.update();
  }, []);
  const forceUpdate = (0, import_react14.useCallback)(() => {
    var _popperInstanceRef$cu2;
    (_popperInstanceRef$cu2 = popperInstanceRef.current) == null ? void 0 : _popperInstanceRef$cu2.forceUpdate();
  }, []);
  const [popperState, setState] = useSafeState_default((0, import_react14.useState)({
    placement,
    update,
    forceUpdate,
    attributes: {},
  ...
  const updateModifier = (0, import_react14.useMemo)(() => ({
  ...
  const nextModifiers = (0, import_react14.useMemo)(() => {
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = (0, import_react15.useRef)(false);
  const waitingForTrigger = (0, import_react15.useRef)(false);
  const handleMouseCapture = (0, import_react15.useCallback)((e) => {
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
  if (typeof (0, import_react17.default)["useSyncExternalStore"] === "function")
    return (0, import_react17.default)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
...
var NavItem2 = React60.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Nav2 = React62.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
  ...
  let isNavbar = false;
  const navbarContext = (0, import_react28.useContext)(NavbarContext_default);
  const cardHeaderContext = (0, import_react28.useContext)(CardHeaderContext_default);
  if (navbarContext) {
...
var NavbarCollapse = React64.forwardRef(({
  ...
  const context6 = (0, import_react29.useContext)(NavbarContext_default);
...
function useMediaQuery(query, targetWindow = typeof window === "undefined" ? void 0 : window) {
  ...
  const [matches, setMatches] = (0, import_react31.useState)(() => mql ? mql.matches : false);
  useIsomorphicEffect_default(() => {
...
function createBreakpointHook(breakpointValues) {
  ...
  function useBreakpoint2(breakpointOrMap, direction, window2) {
    ...
    let query = (0, import_react32.useMemo)(() => Object.entries(breakpointMap).reduce((query2, [key, direction2]) => {
...
var Offcanvas = React70.forwardRef(({
  ...
  const modalManager = (0, import_react33.useRef)();
  bsPrefix = useBootstrapPrefix(bsPrefix, "offcanvas");
  const {
    onToggle
  } = (0, import_react33.useContext)(NavbarContext_default) || {};
  const [showOffcanvas, setShowOffcanvas] = (0, import_react33.useState)(false);
  ...
  const renderBackdrop = (0, import_react33.useCallback)((backdropProps) => (0, import_jsx_runtime65.jsx)("div", {
    ...backdropProps,
...
var Navbar = React73.forwardRef((props, ref) => {
  ...
  const handleCollapse = (0, import_react35.useCallback)((...args) => {
  ...
  const navbarContext = (0, import_react35.useMemo)(() => ({
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime82.jsxs)(import_jsx_runtime81.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react40.cloneElement)(children, triggerProps), (0, import_jsx_runtime80.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var Spinner = React89.forwardRef(({
  ...
  return (0, import_jsx_runtime90.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames66.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react42.useContext)(TabContext_default);
  if (!context6)
...
var Table = React97.forwardRef(({
  ...
  const classes = (0, import_classnames70.default)(className, decoratedBsPrefix, variant && `${decoratedBsPrefix}-${variant}`, size && `${decoratedBsPrefix}-${size}`, striped && `${decoratedBsPrefix}-${typeof striped === "string" ? `striped-${striped}` : "striped"}`, bordered && `${decoratedBsPrefix}-bordered`, borderless && `${decoratedBsPrefix}-borderless`, hover && `${decoratedBsPrefix}-hover`);
  const table = (0, import_jsx_runtime99.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
var ToastFade = React99.forwardRef((props, ref) => (0, import_jsx_runtime102.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React101.forwardRef(({
  ...
  const context6 = (0, import_react44.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
